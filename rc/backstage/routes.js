...
var dirs = fs.readdirSync('client/backstage/drivers');
for(var i=dirs.length-1; i>=0; i--) {
	var dir = dirs[i];
	if(!fs.statSync('client/backstage/drivers/' + dir).isDirectory())
		continue;
	var files = fs.readdirSync('client/backstage/drivers/' + dir);
